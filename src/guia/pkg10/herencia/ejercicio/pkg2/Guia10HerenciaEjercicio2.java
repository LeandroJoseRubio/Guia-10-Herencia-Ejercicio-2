 ...
 */
package guia.pkg10.herencia.ejercicio.pkg2;

import Entidades.Lavadora;
import Entidades.Televisor;

public class Guia10HerenciaEjercicio2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El precio final de la Lavadora es de $" + l1.getPrecio() + ".");
        System.out.println("El precio final del Televisor es de $" + t1.getPrecio() + ".");
